...
* **[Financial Transaction Fraud](https://github.com/pedroleitao-neo4j/finance-ieee-cis-fraud):** Transactional fraud patters using a Graph approach, based on the IEEE-CIS Fraud public dataset.
